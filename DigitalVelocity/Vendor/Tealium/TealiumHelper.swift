...
let tealiumInstanceID = "tealium"
let demoInstanceID = "demo"
...
class TealiumHelper : NSObject {
    ...
    class func startTracking() {
        ...
        // TODO: ENABLE the demo instance
    }
    
    class func demoUpdate(account: String, profile: String, env: String){
        // TODO:
    }
    
    class func demoAddAudienceStreamID(traceID: String){
        // TODO:
    }
    ...
    class func trackEvent(title: String, dataSources: [String:String]){
        ...
        // TODO: send track event to demo instance as well
    ...
    class func stopTracking(){
        ...
        // TODO: destroy demo instance as well
...
extension TealiumHelper{
    ...
    class func incrementLifetimeValue(tealium: Tealium, key: String, value: Int) {
        ...
        // TODO: break up and send to both instances separately
